...
export const ADAPTERS: Record<Provider, ProviderAdapter> = {
  ...
  kimi: adapter("kimi", "unknown", "Kimi runs through its original CLI without a TokenPilot bridge. It remains envelope-only until a content-free, child-authenticated measurement channel is available.", false)
};
