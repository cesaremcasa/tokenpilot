---
name: tokenpilot
description: Show the latest locally measured cache-aware TokenPilot result and evidence state for Grok. Use for TokenPilot reports, token reduction, cache-aware variation, or savings checks; never substitute documentation snapshots or raw window totals.
---

<!-- tokenpilot-managed-skill:v6 grok -->
