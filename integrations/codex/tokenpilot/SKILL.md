---
name: tokenpilot
description: Show the latest locally measured cache-aware TokenPilot token-reduction percentage for Codex. Use for TokenPilot reports, token reduction, cache-aware reduction, or savings checks; never substitute documentation snapshots or raw window totals.
---

<!-- tokenpilot-managed-skill:v5 codex -->
