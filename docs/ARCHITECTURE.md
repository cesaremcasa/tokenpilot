...
Report validation is fail-open as well: missing or degraded content-free outcome evidence keeps a comparison directional and suppresses validated-reduction/economy claims instead of inferring quality from token counters. The concise summary may show the measured cache-aware variation, but it preserves the preliminary or degraded evidence label. The observed outcome safeguard is not statistical equivalence evidence and cannot authorize a validated reduction on its own.
