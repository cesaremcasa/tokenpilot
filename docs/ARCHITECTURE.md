...
Report validation is fail-open as well: missing or degraded content-free outcome evidence keeps a comparison directional and suppresses reduction/economy claims instead of inferring quality from token counters. The observed outcome safeguard is not statistical equivalence evidence and cannot authorize a validated reduction on its own.
